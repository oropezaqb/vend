...
@section('content')
    <div class="col-md-12">
        <div class="card">
            <div class="card-header font-weight-bold">Company: {{ \Auth::user()->currentCompany->company->name }} (Add a New Inventory Quantity Adjustment)</div>
            <div class="card-body">
                <div id="wrapper">
                    <div id="page" class="container">
                        <div class="content">
                            ...
                            @endif
                            <form method="POST" action="/inventory_qty_adjs">
                                @csrf
                                @if ($errors->any())
                                ...
                                <div class="form-group custom-control-inline">
                                    ...
                                    <input type="date" class="form-control @error('date') is-danger @enderror" id="date" name="date" required value="{!! old('date') !!}" oninput="updateLines()">
                                </div>
                                <div class="form-group custom-control-inline">
                                ...
                                <div class="form-group custom-control-inline">
                                    ...
                                    <input list="account_ids" id="account_id0" onchange="setValue(this)" data-id="" class="custom-select @error('account_id') is-danger @enderror" required value="{!! old('account_name', $inventoryShrinkageAcct->title) !!}">
                                    <datalist id="account_ids">
                                        @foreach ($accounts as $account)
                                            <option data-value="{{ $account->id }}">{{ $account->name }}</option>
                                        @endforeach
                                    </datalist>
                                    <input type="hidden" name="account_id" id="account_id0-hidden" value="{!! old('account_id', $inventoryShrinkageAcct->id) !!}">
                                    <input type="hidden" name="account_name" id="name-account_id0-hidden" value="{!! old('account_name', $inventoryShrinkageAcct->title) !!}">
                                </div>
                                <br><br>
