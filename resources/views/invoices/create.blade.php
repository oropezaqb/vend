...
@section('content')
    <div class="col-md-12">
        <div class="card">
            <div class="card-header font-weight-bold">Company: {{ \Auth::user()->currentCompany->company->name }} (Add a New Invoice)</div>
            <div class="card-body">
                <div id="wrapper">
                        ...
                        <div class="content">
                            ...
                            <form method="POST" action="/invoices">
                                ...
                                <div class="form-group custom-control-inline">
                                    ...
                                    <input type="date" class="form-control @error('invoice_date') is-danger @enderror" id="invoice_date" name="invoice_date" required value="{!! old('invoice_date') !!}">
                                </div>
                                <div class="form-group custom-control-inline">
                                ...
                                <div class="form-group custom-control-inline">
                                    ...
                                    <input type="invoice_number" class="form-control" id="invoice_number" name="invoice_number" style="text-align: right;" required value="{!! old('invoice_number') !!}">
                                </div>
                                <br><br>
