    ...
    <body id="page-top">
        ...
        <nav class="navbar navbar-expand-lg navbar-dark bg-primary fixed-top" id="sideNav">
            <a class="navbar-brand js-scroll-trigger" href="#page-top">
                <span class="d-block d-lg-none">Bien Oropeza, CPA</span>
                <span class="d-none d-lg-block"><img class="img-fluid img-profile rounded-circle mx-auto mb-2" src="{{ asset('assets/img/profile2.jpg') }}" alt="" /></span>
            </a>
        ...
        <div class="container-fluid p-0">
            ...
            <section class="resume-section" id="education">
                <div class="resume-section-content">
                    ...
                    <div class="d-flex flex-column flex-md-row justify-content-between mb-5">
                        <div class="flex-grow-1">
                            <h3 class="mb-0">Bicol University</h3>
                            <div class="subheading mb-3">Bachelor of Science</div>
                            <div>Accountancy</div>
                        </div>
                        <div class="flex-shrink-0"><span class="text-primary">June 2008 - March 2012</span></div>
                    </div>
                    <div class="d-flex flex-column flex-md-row justify-content-between mb-5">
                        <div class="flex-grow-1">
                            <h3 class="mb-0">Divine Word College of Legazpi</h3>
                            <div class="subheading mb-3">High School Department</div>
                            <div>Best in Mathematics</div>
                        </div>
                        <div class="flex-shrink-0"><span class="text-primary">June 2004 - March 2008</span></div>
                    </div>
                </div>
            </section>
            <hr class="m-0" />
            ...
            <section class="resume-section" id="skills">
                <div class="resume-section-content">
                    ...
                    <ul class="list-inline dev-icons">
                        ...
                        <li class="list-inline-item"><i class="cbp-ig-icon devicon-jquery-plain"></i></li>
                        <li class="list-inline-item"><i class="fab fa-php"></i></li>
                        <li class="list-inline-item"><i class="fab fa-laravel"></i></li>
                        <li class="list-inline-item"><i class="cbp-ig-icon devicon-mysql-plain"></i></li>
            ...
            <section class="resume-section" id="interests">
                <div class="resume-section-content">
                    ...
                    <p>Apart from being a web developer, I enjoy playing Call of Duty Mobile and reading self-improvement books.</p>
                    <p class="mb-0">I am a chess enthusiast who can play blindfolded. I spend most of my free time exploring the latest technology advancements in software and web application development.</p>
                </div>
            </section>
            <hr class="m-0" />
        </div>
